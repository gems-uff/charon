...
//		charonRules.add("(variationPoint('F'))");
//		charonRules.add("(variant('F1', 'F'))");
//		charonRules.add("(variant('F2', 'F'))");
//		
...
//		charonRules.add("(abstractWorkflow('F'))");
...
//		
//		charonRules.add("(selectElement(E, Path) :- not(abstractWorkflow(E)), not(currentDeselection(E)), not(currentSelection(E)), variant(E, _), not(selectVariant(E)), assertz(conflict(E)))");
//		
//		charonRules.add("(selectElement(E, Path) :- currentDeselection(E), variant(E, _), assertz(conflict(E)))");
//		
//		
...
//		
//		
//		charonRules.add("(checkForInferredSelection(_, Path) :- rule(_, Path))");
//		
//		
...
//		charonRules.add("(tableBody(A,B,E) :- bool(A), bool(B), write(A), write(' \t '), write(B), write(' \t '), evaluate(E, Result), write(Result), nl, fail.)");
	...
	private void setCharonRules2(boolean IsUsingDatabase) {
