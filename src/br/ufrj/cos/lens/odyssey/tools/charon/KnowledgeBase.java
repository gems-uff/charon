...
//		charonRules.add("(abstractWorkflow('D1'))");
		...
		//Initialize derivation (Select mandatory activities to the abstract workflow)
		...
		charonRules.add("(isValidDerivedWorkflow(_) :- findall(ActivityIdd, mandatory(ActivityIdd), MandatoryList), findall(ActivityId, abstractWorkflow(ActivityId), AbstActvList), containsAllMandatories(MandatoryList, AbstActvList), findall(VPId, variationPoint(VPId), VPList), checkVariationPoints(VPList, AbstActvList))");
...
//		charonRules.add("(initializeDerivation(AbstWfId) :- findall(ActivityId, mandatory(ActivityId), ActivityIdList), assertz(abstractWorkflow(ActivityId)))");
//		validateSelection()
...
//		
//		//Tempo de dura��o de uma execu��o de um experimento
...
//		
//		//Tempo de execu��o de uma atividade do experimento
